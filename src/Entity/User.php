...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Regex(
        ...
        match: true,
        message: 'Le mot de passe doit contenir au moins une minuscule, une majuscule, un chiffre et d\'un caractère spécial.',
    )]
    #[ORM\Column]
    ...
    #[Assert\Length(
        min: 2,
        max: 255,
        minMessage: 'Le prénom doit contenir au maximum {{ limit }} caractères.',
